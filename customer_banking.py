...
def main():
    ...
    savings_interest = float(input("Please enter the interest rate for your savings account (%): "))
    savings_maturity = int(input("Please enter the number of months for your savings account: "))
    ...
    print(f"Interest Earned In Savings Account: ${interest_earned:,.2f}")
    ...
    print(f"Interest Earned In CD Account: ${interest_earned:,.2f}")
